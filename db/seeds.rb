...
user = User.create!([
  { :username => "Meow1", :email => "meow1@meow.com", :password => "1234", :password_confirmation => "1234", birthday: "1990-01-01", location: "San Francisco, ca", latitude: 37.7749, longitude: -122.419 },
